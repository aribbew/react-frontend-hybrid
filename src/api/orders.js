...
export async function getOrdersByTableApi(idTable, status = "", ordering = "") {
  try {
    ...
    const url = `${BASE_API}/api/orders/?${tableFilter}&${statusFilter}&${ordering}&${closeFilter}`;
...
export async function getOrdersByPaymentsApi(idPayment) {
  try {
...
// export async function getOrdersCommentsByCartApi(idComment) {
//   try {
//     const url = `${BASE_API}/api/orders/${idComment}/`;
//     const params = {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
